...
if (!class_exists('st_categories')) {
    class st_categories extends WP_Widget
    {
        ...
        public function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('style')); ?>"><?php echo __("Header style", ST_TEXTDOMAIN); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>"> <?php echo __("Choose a category", ST_TEXTDOMAIN); ?>
                    :<br>
