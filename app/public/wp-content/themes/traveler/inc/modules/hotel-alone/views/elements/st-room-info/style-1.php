    ...
    <div class="info">
        ...
        if ( get_post_meta( get_the_ID(), 'price_by_per_person', true ) == 'on' ) : ?>
            ...
            <div class="price">
                ...
                echo TravelHelper::format_money($adult_price); ?><span class="small"><?php esc_html_e("/person/night", ST_TEXTDOMAIN) ?></span>
            </div>
            <p><?php esc_html_e("Child Price",ST_TEXTDOMAIN) ?></p>
            <div class="price">
                <?php
                $child_price = get_post_meta(get_the_ID(),'child_price',true);
                echo TravelHelper::format_money($child_price); ?><span class="small"><?php esc_html_e("/person/night", ST_TEXTDOMAIN) ?></span>
            </div>
            <?php
        else: ?>
