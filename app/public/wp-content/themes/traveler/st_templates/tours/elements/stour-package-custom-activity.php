            ...
            if (!empty((array)$tour_package_custom)) {
                foreach ($tour_package_custom as $k => $v) {
                    ...
                    <tr>
                        ...
                        <td data-name="<?php echo __('Activity name', ST_TEXTDOMAIN); ?>"><input type="text" class="activity-name" value="<?php echo esc_attr($v->activity_name); ?>"/></td>
                        <td data-name="<?php echo __('Price', ST_TEXTDOMAIN); ?>"><input type="text" class="activity-price" value="<?php echo esc_attr($v->activity_price); ?>"/></td>
                    </tr>
                    <?php
                }
            }
