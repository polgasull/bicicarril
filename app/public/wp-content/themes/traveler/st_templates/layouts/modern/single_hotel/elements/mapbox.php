    ...
    <div class="container">
      <div class="mapbox-content">
        <div class="mapbox-text">
          <h1 class="mapbox-heading"><?php esc_html_e( 'Location', ST_TEXTDOMAIN ); ?></h1>
          <div class="row">
            <?php
            if ( ! empty( $list_location ) && is_array( $list_location ) && count( $list_location ) > 0 ) :
              foreach ( $list_location as $item_location ) : ?>
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="list-location-item">
                    ...
                    <a target="_blank" href="<?php echo esc_url ( $link_google_map . $item_location['location_address'] ) ?>" class="item-link"><?php esc_html_e( 'Get Directions', ST_TEXTDOMAIN ) ?></a>
                  </div>
                </div>
                <?php
              endforeach;
