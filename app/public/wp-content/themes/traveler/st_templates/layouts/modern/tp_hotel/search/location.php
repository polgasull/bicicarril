<?php
    ...
    $default=array(
        'title'=>'',
        'placeholder'=>__('City or hotel name', ST_TEXTDOMAIN),
        'is_required'=>'',
    );
    if(isset($data)){
    ...
    <label><?php echo __( 'Destination', ST_TEXTDOMAIN ); ?></label>
        <div class="render">
            <div class="st-select-wrapper tp-hotel-wrapper" >
                <input <?php echo esc_attr($is_required); ?> id="location_destination_h" type="text" data-text="<?php echo esc_html__('hotel(s)', ST_TEXTDOMAIN); ?>" data-locale="<?php echo esc_attr($locale_default); ?>" class="tp-hotel-destination" autocomplete="off" data-name="destination" value="" placeholder ="<?php echo __( 'City or hotel name', ST_TEXTDOMAIN ); ?>" >
            </div>
        </div>
