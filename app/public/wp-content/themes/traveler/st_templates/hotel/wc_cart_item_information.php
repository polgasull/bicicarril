    ...
    <div class="cart_item_group" style='margin-bottom: 10px'>
        ...
        <ul class="booking-item-description">
            ...
            if ( $price_by_per_person == 'on' ) : ?>
                ...
                <li><?php echo __('Adult Price:',ST_TEXTDOMAIN);?> <?php echo ($st_booking_data['room_num_search']); ?> x <?php echo ($st_booking_data['adult_number']); ?> x <?php echo TravelHelper::format_money(isset($st_booking_data['adult_price']) ? $st_booking_data['adult_price'] : 0) ; ?></li>
                <li><?php echo __('Child Price:',ST_TEXTDOMAIN);?> <?php echo ($st_booking_data['room_num_search']); ?> x <?php echo ($st_booking_data['child_number']); ?> x <?php echo TravelHelper::format_money(isset($st_booking_data['child_price']) ? $st_booking_data['child_price'] : 0) ; ?></li>
                <?php
            else: ?>
