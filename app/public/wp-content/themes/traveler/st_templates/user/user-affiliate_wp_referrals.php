    ...
    <table>
        ...
        <tbody>
            <?php foreach ($data_visits as $referral)
            {
                ...
                ?>
                <tr>
                    <td class="referral-reference" data-th="<?php esc_html_e( 'Reference', ST_TEXTDOMAIN ); ?>"><?php echo esc_html($reference) ?></td>
                    ...
                    <td class="referral-status <?php echo esc_attr($referral->status); ?>" data-th="<?php esc_html_e( 'Status', ST_TEXTDOMAIN ); ?>"><?php echo affwp_get_referral_status_label( $referral ); ?></td>
