...
<div class="alert alert-info mt20" role="alert">
	...
	<p class="mt20"><strong><?php echo __('Account Name: ') ?></strong> <em><?php echo esc_html($cancel_data['your_bank']['account_name']); ?></em></p>
	<p class="mt10"><strong><?php echo __('Account Number: ') ?></strong> <em><?php echo esc_html($cancel_data['your_bank']['account_number']); ?></em></p>
	<p class="mt10"><strong><?php echo __('Bank Name: ') ?></strong> <em><?php echo esc_html($cancel_data['your_bank']['bank_name']); ?></em></p>
	<p class="mt10"><strong><?php echo __('Swift Code: ') ?></strong> <em><?php echo esc_html($cancel_data['your_bank']['swift_code']); ?></em></p>
