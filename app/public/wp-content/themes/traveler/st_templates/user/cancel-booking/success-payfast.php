...
<div class="alert alert-info mt20" role="alert">
	...
	<p class="mt20"><strong><?php echo __('Your payfast transaction ID: ') ?></strong> <em><?php echo esc_html($cancel_data['your_payfast']['transaction_id']); ?></em></p>
	...
	<!-- <p class="mt20"><strong><?php echo __('Description: ') ?></strong> <em><?php echo esc_html($cancel_data['detail']); ?></em></p> -->
</div>