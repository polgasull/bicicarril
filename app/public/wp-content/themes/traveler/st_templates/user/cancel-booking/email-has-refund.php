...
<table id="" class="wrapper" style="width: 1000px; color: #666; border: 1px solid #DDD; margin-top: 70px;" width="90%"
    ...
    <tr>
        <td width="40%" style="padding: 10px 15px;">
            <strong><?php echo __('Cancellation Fee: ', ST_TEXTDOMAIN); ?></strong></td>
    ...
    <tr>
        <td width="40%" style="padding: 10px 15px;">
            <strong><?php echo __('Refunded Amount: ', ST_TEXTDOMAIN); ?></strong></td>
        <td align="right" style="padding: 10px 15px;"
    ...
    <tr>
        <td colspan="2" style="padding: 10px 15px;"><a
                    href="<?php echo esc_url($refund_manager); ?>"><?php echo __('Go to the Refund Manager', ST_TEXTDOMAIN); ?></a>
        </td>
    </tr>
    </tbody>
</table>