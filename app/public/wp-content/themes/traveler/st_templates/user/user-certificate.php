                ...
                <div class="col-md-7">
                    ...
                    <span class="input-group-btn">
                        <span class="btn btn-primary btn-file">
                            <?php _e("Browse…",ST_TEXTDOMAIN) ?> <input type="file" name="st_certificates_st_hotel" data-type="st_hotel"  class="st_certificates" value="<?php if( isset($_FILES['st_certificates_st_hotel']) ) echo esc_html($_FILES['st_certificates_st_hotel']['name']); ?>">
                        </span>
                    </span>
