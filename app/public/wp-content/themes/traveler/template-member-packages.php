					...
					<div class="package-item">
						...
						<div class="package-content">
							...
							<div class="list-featured">
								...
								<div class="featured-item"><i class="fa fa-check"></i><strong><?php echo balanceTags($cls_packages->convert_item($val->package_item_upload)); ?></strong> <?php echo __('can upload', ST_TEXTDOMAIN) ?></div>
								<div class="featured-item"><i class="fa fa-check"></i><strong><?php echo balanceTags($cls_packages->convert_item($val->package_item_featured)); ?></strong> <?php echo __('can set featured', ST_TEXTDOMAIN) ?></div>
